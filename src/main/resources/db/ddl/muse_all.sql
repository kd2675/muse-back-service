...
-- Core content tables for muse (home/contest/gallery/artwork/profile)
-- Generated: 2026-02-04
...
CREATE TABLE IF NOT EXISTS gallery_highlight (
    gallery_highlight_id BIGINT AUTO_INCREMENT PRIMARY KEY,
    artwork_id BIGINT NOT NULL,
    sort_order INT NOT NULL,
    create_date DATETIME NOT NULL,
    update_date DATETIME NOT NULL,
    CONSTRAINT fk_gallery_highlight_artwork
        FOREIGN KEY (artwork_id) REFERENCES artwork(artwork_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
