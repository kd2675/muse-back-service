package muse.back.service.database.pub;

import com.zaxxer.hikari.HikariDataSource;
import muse.back.service.common.datasource.RoutingDataSource;
...
@EnableJpaRepositories(
        basePackages = {"muse.back.service.database.pub.repository"},
...
public class PubDataConfig {
    ...
    public LocalContainerEntityManagerFactoryBean pubEntityManagerFactory(
        ...
        return builder.dataSource(new LazyConnectionDataSourceProxy(routingDataSource))
                .packages("muse.back.service.database.pub.entity")
